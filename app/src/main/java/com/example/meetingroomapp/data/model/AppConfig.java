...
public class AppConfig {
    ...
    private String appId, appSecret, roomId, clientId, clientSecret, tenantId, roomEmail, roomName;
    ...
    public static final String KEY_PLATFORM = "platform", KEY_APP_ID = "app_id", KEY_APP_SECRET = "app_secret", KEY_ROOM_ID = "room_id", KEY_CLIENT_ID = "client_id", KEY_CLIENT_SECRET = "client_secret", KEY_TENANT_ID = "tenant_id", KEY_ROOM_EMAIL = "room_email", KEY_ROOM_NAME = "room_name";
